#!/bin/bash
# COPY of generate_dtb.sh for runs 69-74 (2026-09-23): appends $XEN_EXTRA to the Xen command line.
...
case "${TEST_CASE}" in
    "dom0-test" | "dom0-smp-test")
        ...
        PLATFORM_XEN_BOOTARGS="com1=poll sched=null dom0_max_vcpus=1 dom0_mem=${DOM0_MEM:-1024M}${XEN_EXTRA:+ $XEN_EXTRA} loglvl=all guest_loglvl=all"
